...
def train():
    ...
    for epoch in range(MAX_EPOCHS):
        ...
        for batch_idx, (x_true, indices) in enumerate(train_loader_tqdm):
            ...
            # regularizer.W.grad = grad_W # Decided to keep W fixed as in the original optimized sketch
            optimizer.step()
            ...
            train_loader_tqdm.set_postfix({'Outer Loss': f"{loss:.4e}", 'Avg NMSE': f"{running_nmse_loss/total_train_samples:.4e}"})
